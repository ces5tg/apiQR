...
import { Text, View, StyleSheet, Button, Animated, StatusBar, TouchableOpacity } from 'react-native';
  ...
  if (hasPermission === false) {
    return (
      <View style={styles.container}>
        ...
        <Button title="Permitir acceso a la cámara" onPress={(Logi) => setHasPermission(null)} />
      </View>
    );
  }
